        ...
        case 'remove':
          if (chat.welcome) {
            ...
            for (let user of participants) {
              ...
              let pp = 'https://i.ibb.co/xfzCyWH/IMG-20211221-220942.jpg'
              let kai = await(await fetch('https://i.ibb.co/xfzCyWH/IMG-20211221-220942.jpg')).buffer()
              let poi = await(await fetch('https://i.ibb.co/xfzCyWH/IMG-20211221-220942.jpg')).buffer()
              try {
